...
\subsubsection{Diseño}
	\begin{itemize}
		\item Se despliega al dar clic en el \IUbutton{GUARDAR} de la pantalla \IUref{IU1.4}{Perfil Usuario}.
		\item Se despliega al dar clic en el \IUbutton{REGISTRAR} de la pantalla \IUref{IU1.6}{Agregar Protegido}.
\end{itemize}		

\IUfig[.3]{IU1-5}{IU1.5}{Seguridad}
