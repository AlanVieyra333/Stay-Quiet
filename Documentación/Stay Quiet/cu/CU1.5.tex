\begin{UseCase}{CU1.5}{Editar Protegido}{
	Se describe el comportamiento y funcionamiento de la aplicación para editar los datos de un Protegido.
		...
		\UCitem{Precondiciones}{
			El usuario Protector solo podra modificar los datos.
		}
	...
	\begin{UCtrayectoria}{Principal}
		...
		\UCpaso[\UCsist] Verifica la regla de negocio \BRref{RN1.1}{Campos nulos}. \Trayref{A}
		\UCpaso[\UCsist] Verifica la regla de negocio \BRref{RN1.2}{Formato general para el registro de un Protector}. \Trayref{B}
		...
		\UCpaso[\UCsist] Despliega la pantalla \IUref{IU1.3}{Pantalla Inicial} con el usuario Protegido modificado.
	\end{UCtrayectoria}
