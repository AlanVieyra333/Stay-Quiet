\begin{UseCase}{CU1.3}{Editar Protector}{
	Se describe el comportamiento y funcionamiento de la aplicación para la modificación los datos del Protector.
}
		\UCitem{Versión}{1.0}
	...
	\begin{UCtrayectoria}{Principal}
		...
		\UCpaso[\UCsist] Despliega el menú con tres opciones \IUbutton{Perfil},\IUbutton{Configuración} y \IUbutton{Cerrar Sesión}.
