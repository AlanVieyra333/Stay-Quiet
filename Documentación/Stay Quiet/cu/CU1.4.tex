\begin{UseCase}{CU1.4}{Agregar Protegido}{
	Se describe el comportamiento y funcionamiento de la aplicación para agregar Protegidos a un catalogo de contactos de un Protector y generar un PIN de ingreso para el Protegido.
}
		\UCitem{Versión}{1.0}
