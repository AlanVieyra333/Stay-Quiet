...
\begin{NFRequieriments}
	...
	\NFRitem{RF-04}{Sensibilidad en monitoreo }
	...
	\NFRitem{RF-05}{Actualización de ubicación geográfica}
	...
	\NFRitem{RF-06}{Alerta de riesgos}
...
\begin{NFRequieriments}
	\NFRitem{RNF-01}{Política de privacidad}
	...
	\NFRitem{RNF-02}{Disponibilidad del Sistema}
	{El sistema deberá estar disponible cuando el usuario así lo requiera.}
	\NFRitem{RNF-03}{Documentación del sistema}
...
\begin{figure}[htbp!]
	\begin{center}
		\includegraphics[scale = 0.6]{Plan/Imagen/Cronograma.jpg}
	\end{center}
\end{figure}
...
\begin{figure}[htbp!]
	\begin{center}
		\includegraphics[scale = 0.5]{Plan/Imagen/organigrama.jpg}
	\end{center}
\end{figure}
\newpage 
